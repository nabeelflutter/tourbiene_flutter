                            ...
                            Container(
                                ...
                                child: const CircleAvatar(
                                  backgroundImage: NetworkImage(
                                    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTZfh9t57WAyrvmEluE7KFN3gs_w6fMfIHpcQ&usqp=CAU',
                                  ),
                                )),
                            const SizedBox(
                              height: 8,
            ...
            Expanded(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) => shoesItem(
                    index: index,
                    images:
                        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRwQVcijjhQ_Ty1VXi8kIGIOmQNKrjL6spbEw&usqp=CAU',
                    context: context),
              ),
            ))
          ],
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => CollectiblesHeroPage(
                  immage: images,
                  index: index,
                ),
              ));
