                            ...
                            Container(
                                ...
                                child: const CircleAvatar(
                                  backgroundImage: NetworkImage(
                                    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRnf2hVvnaSjsfORA7rG2cOtUAKdq5QthbxiA&usqp=CAU',
                                  ),
                                )),
                            const SizedBox(
                              height: 8,
            ...
            Expanded(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) => shoesItem(
                    index: index,
                    images:
                        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRLUX2HYudjiRcBi4sdC96Rh8hQOC_FBdxKVw&usqp=CAU',
                    context: context),
              ),
            ))
          ],
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => FishingHeroPage(
                  immage: images,
                  index: index,
                ),
              ));
