...
import 'package:tourbiene/screens/googlescreens/register_btns_page.dart';
import 'package:tourbiene/widgets/check_connectivity.dart';

class GoogleRegisterPage extends StatelessWidget {
  static const String pageName = "GoogleRegisterPage";
  const GoogleRegisterPage({Key? key}) : super(key: key);
